  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12">
        <div className="mx-auto max-w-md space-y-6 rounded-2xl border border-border bg-card p-8 shadow-xl">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-foreground">Hasło zmienione!</h2>
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12">
      <div className="mx-auto max-w-md space-y-6 rounded-2xl border border-border bg-card p-8 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? 'Resetowanie hasła...' : 'Zmień hasło'}
          </button>
        </form>
      </div>
    </div>
